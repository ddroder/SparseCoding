...
parser.add_argument('--encode-iters', type=int, default=50, metavar='M',
...
data_size  = patch_size**2 #this is output size
# data_size=1024
code_size  = data_size * args.overComplete #this is input size
# code_size=676
# 
